...
Usage:
    ./run_in_container.sh python tools/smoke_test_larformer_p3.py
    ./run_in_container.sh python tools/smoke_test_larformer_p3.py --overfit-event 0 --n-events 50 --cap 30000

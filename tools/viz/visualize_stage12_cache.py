...
`tools/larformer/build_stage12_cache_event.py` (or the shard driver).
...
# ---------------------------------------------------------------------------
# Color helpers (match tools/viz/visualize_larformer_gt.py palette)
# ---------------------------------------------------------------------------
        ...
        if "entry_0" not in f:
            ...
            if "raw" in f and "stage3" in f:
                hint = (
                    ...
                    "`tools/larformer/build_stage12_cache_event.py` and rerun the "
                    "visualizer."
                )
            raise KeyError(

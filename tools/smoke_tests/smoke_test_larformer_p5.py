...
Usage:
    ./run_in_container.sh python tools/smoke_tests/smoke_test_larformer_p5.py
    ./run_in_container.sh python tools/smoke_tests/smoke_test_larformer_p5.py --overfit-event 0 --n-events 50
"""

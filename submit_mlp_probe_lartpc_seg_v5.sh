...
#SBATCH --job-name=mlp_v5_seg
#SBATCH --output=logs/mlp_v5_seg_%j.%N.log
#SBATCH --mem-per-cpu=4000
#SBATCH --cpus-per-task=40
#SBATCH --time=15:00:00
#SBATCH --partition=wongjiradlab
#SBATCH --gres=gpu:p100:4
#SBATCH --error=logs/mlp_v5_seg_%j.%N.err
...
apptainer exec --nv --bind /cluster:/cluster \
    ...
    $container bash -c "cd ${WORKDIR} && source run_mlp_probe_lartpc_seg_v5.sh"

...
# misc custom setting
batch_size = 72  # Adjust based on GPU memory; LArTPC events can be large
...
model = dict(
    ...
    mask_size_warmup_ratio=0.04,
    mask_ratio_start=0.3,   # Mask 30% initially
    mask_ratio_base=0.8,    # Mask 80% at end
    mask_ratio_warmup_ratio=0.04,
    mask_jitter=0.125,      # half of grid_size 

    # Temperature schedule
    teacher_temp_start=0.04,
    teacher_temp_base=0.07,
    teacher_temp_warmup_ratio=0.04,
    student_temp=0.1,

...
enable_wandb = True
wandb_project = "pointcept_ubsimonly"
save_path = "sonata/lartpc_v6_h200_noghosts_pretrain_logspace_resume"

#weight="/cluster/tufts/wongjiradlabnu/twongj01/pointcept_env/pointcept/sonata/lartpc_v6_h200_noghosts_pretrain/model/epoch_50.pth"
...
lr_final_div_factor=20.0 # original
...
data = dict(
    ...
    val=dict(
        ...
        coord_scale=1.0,
        include_ghosts=False,  # SSNet doesn't include ghosts
        exclude_other=True,

...
`configs/lartpc/lora_finetune/archive/lorafinetune-sonata-v1m1-lartpc-v6-deghost.py`. Two changes
make this work:
...
# `configs/lartpc/lora_finetune/archive/lorafinetune-sonata-v1m1-lartpc-v6-deghost.py`. Must match

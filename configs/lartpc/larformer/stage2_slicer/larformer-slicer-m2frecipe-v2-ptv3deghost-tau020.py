"""ptv3deghost cascade at deghost_threshold_val=0.20 — slicer-response test.
...
the cascade at tau=0.20 to measure the SLICER's response to the dirtier
...
model = dict(deghost_threshold_val=0.20)
save_path = "exp/larformer_slicer_m2frecipe_v2_ptv3deghost_tau020_eval"

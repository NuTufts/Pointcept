...
The keypoint model is imported from the config that produced the trained ckpt
    configs/lartpc/larformer-keypoint2-particle-predmask-cached-v1.py
...
_casc = Config.fromfile(
    os.path.join(_CFG_DIR, "larformer-particle-fullcascade-ptv3crosslevel.py"))
_kp = Config.fromfile(
    os.path.join(_CFG_DIR, "larformer-keypoint2-particle-predmask-cached-v1.py"))

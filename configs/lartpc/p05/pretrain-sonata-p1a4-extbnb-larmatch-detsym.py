...
save_path = "sonata/p1a/P1A.4-extbnb_larmatch-s0"

TRAIN_FILE_LIST = "/projects/u6jo/work/pointcept/lartpc/filelists/h5list_v3_extbnb_only_train_415680.txt"
...
data = dict(
    ...
    train=dict(
        ...
        test_mode=False,
        loop=1,
        # ---- P1A.4: EXTBNB data + LArMatch filter ----

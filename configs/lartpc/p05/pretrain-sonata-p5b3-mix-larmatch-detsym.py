...
save_path = "sonata/p5b/P5B.3-mix_larmatch-s0"

TRAIN_FILE_LIST = "/projects/u6jo/work/pointcept/lartpc/filelists/h5list_v3_mix1to1_train.txt"
VAL_FILE_LIST = "/projects/u6jo/work/pointcept/lartpc/filelists/h5list_v3_combined_val.txt"
...
data = dict(
    ...
    train=dict(
        ...
        test_mode=False,
        loop=1,
        # ---- P5B.3: symmetric LArMatch-filtered mixture ----

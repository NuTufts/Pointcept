...
P5E S-width x 104k unique MC events at full compute C
(MATCHED_BUDGET). Scaling-law grid cell; base = P1A.4b deltas.
"""
...
save_path = "sonata/p5e/P5E.S2-mc_lm_104k-s0"

TRAIN_FILE_LIST = "/projects/u6jo/work/pointcept/lartpc/filelists/h5list_v3_mc_only_train_103920.txt"
...
snapshot_at_iters = [500, 1000, 2000, 4000, 8000, 16000, 32000, 64000, 96000, 128000, 160000, 192000, 224000, 256000, 288000]
...
model = dict(
    ...
    backbone=dict(
        ...
        enc_channels=(16, 32, 64, 128, 160),
        enc_num_head=(2, 4, 8, 16, 20),
    ...
    head_in_channels=352,  # up_cast_level=2: 64 + 128 + 160 (S width)
...
data = dict(
    ...
    train=dict(
        ...
        test_mode=False,
        loop=1,
        # ---- MC + LArMatch filter (lm_score fallback) ----

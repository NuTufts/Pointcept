...
P5E S-width LR-sweep point (lr=0.0001) at C/4: bounds the fixed-LR
...
save_path = "sonata/p5e/P5E.S6-mc_lm_416k_c4_lr1-s0"
...
snapshot_at_iters = [500, 1000, 2000, 4000, 8000, 16000, 32000, 48000, 64000]

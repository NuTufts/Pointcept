...
#SBATCH --output=larsonata.v4.l40s.%j.%N.log
#SBATCH --mem-per-cpu=2000
#SBATCH --cpus-per-task=20
#SBATCH --time=2-00:00:00
#SBATCH --partition=gpu
#SBATCH --gres=gpu:l40s:2
#SBATCH --error=larsonata.v4.l40s.%j.%N.err
...
apptainer exec --nv --bind /cluster:/cluster $container bash -c "cd ${WORKDIR} && source run_pretraining_pax_l40s.sh"

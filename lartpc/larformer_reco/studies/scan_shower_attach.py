...
Run INSIDE the container:
    ./run_in_local_pointcept_container.sh python \
        lartpc/larformer_reco/studies/scan_shower_attach.py
"""
import os
import sys
...
from lartpc.larformer_reco.trajfit import nu_interaction as ni
from lartpc.larformer_reco.trajfit.shower_trunk import trunk_vertex_biased
from lartpc.larformer_reco.trajfit.shower_connect import connection_geometry
from lartpc.larformer_reco.trajfit.shower_truth import load_shower_fragments, shower_is_primary

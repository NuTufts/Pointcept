...
NPART=$(bash lartpc/data_prep/uboone_official/retry_incomplete_tranche.sh lartpc/data_prep/uboone_official/tranche_nue_run1_half.spec --dry-run | grep -c " partial " || true)

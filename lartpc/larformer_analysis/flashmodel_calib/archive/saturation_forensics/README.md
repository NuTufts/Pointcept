...
## Relocation note (2026-09-11)

This README was written for the flat `flashmodel_calib/` folder. The saturation
scripts and CSVs it lists now live here (`archive/saturation_forensics/`); the
gamma estimators it mentions are in `../july2026_gamma/` and are superseded by
`../../gammacal` (see `../../PROTOCOL.md`). The per-run gamma section above
describes the state as of July 2026; the current numbers are in
`../../CALIBRATION_LOG.md`.

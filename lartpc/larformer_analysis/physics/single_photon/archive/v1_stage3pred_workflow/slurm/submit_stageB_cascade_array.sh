...
#SBATCH --time=8:00:00
#SBATCH --array=0-29
#SBATCH --output=/cluster/tufts/wongjiradlabnu/twongj01/pointcept_env/pointcept/lartpc/larformer_analysis/physics/single_photon/slurm/logs/stageB_scale/casc.%A_%a.log
#SBATCH --error=/cluster/tufts/wongjiradlabnu/twongj01/pointcept_env/pointcept/lartpc/larformer_analysis/physics/single_photon/slurm/logs/stageB_scale/casc.%A_%a.err

SP=/cluster/tufts/wongjiradlabnu/twongj01/pointcept_env/pointcept/lartpc/larformer_analysis/physics/single_photon
CONFIG=/cluster/tufts/wongjiradlabnu/twongj01/pointcept_env/pointcept/lartpc/data_prep/uboone_official/larformer_configs/single_photon_scale1500.conf

...
#SBATCH --time=8:00:00
#SBATCH --array=0-5
#SBATCH --output=/cluster/tufts/wongjiradlabnu/twongj01/pointcept_env/pointcept/lartpc/larformer_analysis/physics/single_photon/slurm/logs/dgfix/arm.%A_%a.log
#SBATCH --error=/cluster/tufts/wongjiradlabnu/twongj01/pointcept_env/pointcept/lartpc/larformer_analysis/physics/single_photon/slurm/logs/dgfix/arm.%A_%a.err

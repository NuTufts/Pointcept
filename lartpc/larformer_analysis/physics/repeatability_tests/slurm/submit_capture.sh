...
#SBATCH --time=2:00:00
#SBATCH --output=/cluster/tufts/wongjiradlabnu/twongj01/pointcept_env/pointcept/lartpc/larformer_analysis/physics/repeatability_tests/slurm/logs/capture/cap.%j.log
#SBATCH --error=/cluster/tufts/wongjiradlabnu/twongj01/pointcept_env/pointcept/lartpc/larformer_analysis/physics/repeatability_tests/slurm/logs/capture/cap.%j.err
...
SP=${POINTCEPT}/lartpc/larformer_analysis/physics/single_photon   # input lists live here

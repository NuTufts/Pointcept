...
#SBATCH --output=logs/bnbnu_chargedpiplus_corsika/gridlog_dl2h5.%j.%A_%a.%N.log
#SBATCH --mem-per-cpu=8000
#SBATCH --cpus-per-task=1
#SBATCH --time=3-00:00:00
#SBATCH --partition=batch
#SBATCH --error=logs/bnbnu_chargedpiplus_corsika/griderr_dl2h5.%j.%A_%a.%N.err
#SBATCH --array=1-79
...
apptainer exec --bind /cluster:/cluster $container bash -c "cd ${WORKDIR} && source run_corsika_bnb_nu_chargedpiplus.sh"

...
#SBATCH --output=logs/bnbnue_corsika/gridlog_dl2h5.%j.%A_%a.%N.log
...
apptainer exec --bind /cluster:/cluster $container bash -c "cd ${WORKDIR} && source run_corsika_bnb_nue.sh"

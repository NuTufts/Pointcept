...
#SBATCH --output=logs/pointcept_lantern/gridlog_bnbnu_pi0filter_coriska_pointcept_lantern.%j.%A_%a.%N.log
#SBATCH --error=logs/pointcept_lantern/griderr_bnbnu_pi0filter_coriska_pointcept_lantern.%j.%A_%a.%N.err

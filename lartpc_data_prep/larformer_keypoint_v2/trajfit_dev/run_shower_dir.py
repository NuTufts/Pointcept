...
Run INSIDE the container:
    ./run_in_local_pointcept_container.sh python \
        lartpc_data_prep/larformer_keypoint_v2/trajfit_dev/run_shower_dir.py \
...
from shower_trunk import trunk_pca, trunk_elpigraph, trunk_vertex_biased
from shower_connect import connection_geometry, connects
from nu_interaction import vertex_candidates, read_nu_vertices

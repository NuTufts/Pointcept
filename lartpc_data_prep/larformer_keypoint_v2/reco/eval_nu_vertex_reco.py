...
Run inside the pointcept container (numpy/torch/scipy/h5py/matplotlib):
    ...
    python -m lartpc_data_prep.larformer_keypoint_v2.reco.eval_nu_vertex_reco \
...
(or invoke the file directly:
 ``python lartpc_data_prep/larformer_keypoint_v2/reco/eval_nu_vertex_reco.py ...``)
"""
...
if __package__ in (None, ""):                        # pragma: no cover
    ...
    from reco import KeypointRecoTorch, KeypointRecoParams, io
else:
    from . import io

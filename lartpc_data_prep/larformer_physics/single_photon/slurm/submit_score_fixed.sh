...
#SBATCH --time=2:00:00
#SBATCH --array=0-5
#SBATCH --output=/cluster/tufts/wongjiradlabnu/twongj01/pointcept_env/pointcept/lartpc_data_prep/larformer_physics/single_photon/slurm/logs/scorefix/score.%A_%a.log
#SBATCH --error=/cluster/tufts/wongjiradlabnu/twongj01/pointcept_env/pointcept/lartpc_data_prep/larformer_physics/single_photon/slurm/logs/scorefix/score.%A_%a.err

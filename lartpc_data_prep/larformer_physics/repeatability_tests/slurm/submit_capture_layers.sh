...
#SBATCH --time=2:00:00
#SBATCH --output=/cluster/tufts/wongjiradlabnu/twongj01/pointcept_env/pointcept/lartpc_data_prep/larformer_physics/repeatability_tests/slurm/logs/layers/cap.%j.log
#SBATCH --error=/cluster/tufts/wongjiradlabnu/twongj01/pointcept_env/pointcept/lartpc_data_prep/larformer_physics/repeatability_tests/slurm/logs/layers/cap.%j.err
...
SP=${POINTCEPT}/lartpc_data_prep/larformer_physics/single_photon

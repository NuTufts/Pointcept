...
#          sbatch lartpc_data_prep/larformer_particle_analysis/slurm/submit_valtest.sh \
#                 lartpc_data_prep/larformer_particle_analysis/slurm/valtest_pi0_ptv3crosslevel.conf
...
INNER_CMD="\
cd ${WORKDIR} && \
python lartpc_data_prep/larformer_particle_analysis/slurm/run_valtest_per_task.py \
    --tag ${TAG} \

#!/bin/bash
#SBATCH --job-name=LoRa_v_deghoster_extbnb
#SBATCH --output=logs/LoRa_v_deghoster_extbnb_%j.%N.log
#SBATCH --mem-per-cpu=2000
#SBATCH --cpus-per-task=32
#SBATCH --time=2-00:00:00
#SBATCH --partition=gpu
#SBATCH --gpus=2
#SBATCH --constraint="h200-141G|l40s-48G|a100-80G|h100-80G"
#SBATCH --error=logs/LoRa_v_deghoster_extbnb_%j.%N.err

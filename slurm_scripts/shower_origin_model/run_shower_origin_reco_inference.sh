...
python3 tools/run_shower_origin_inference.py --config configs/lartpc/shower-origin-sonata-v1m1-v3-reco-fragments-p1cmp075.py --data-list lartpc_data_prep/shower_origin_reco_scripts/h5list_showeroriginreco_ncpi0filter_validated_val.txt --checkpoint shower_origin/sonata_v1m1_v3_v6backbone_pax_pi0filter_recofragments/model/model_epoch165.pth --output shower_origin_reco_results.h5
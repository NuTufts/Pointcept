...
#   sbatch submit_larformer_particle_m2frecipe_a100.sh

#SBATCH --job-name=lf-particle-m2f
#SBATCH --mem=192G
...
#SBATCH --output=logs/lf-particle-m2f.%j.%N.log
#SBATCH --error=logs/lf-particle-m2f.%j.%N.err
...
SELF=${SCRIPT_DIR}/submit_larformer_particle_m2frecipe_a100.sh

SAVE=${WORKDIR}/exp/larformer_particle_v2_cached_ptv3crosslevel_m2frecipe

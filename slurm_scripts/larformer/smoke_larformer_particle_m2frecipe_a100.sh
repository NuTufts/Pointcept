...
#SBATCH --job-name=lf-particle-smoke-m2f
#SBATCH --mem=64G
...
#SBATCH --output=logs/lf-particle-smoke-m2f.%j.%N.log
#SBATCH --error=logs/lf-particle-smoke-m2f.%j.%N.err
...
OLD_CACHE=/cluster/tufts/wongjiradlab/larbys/data/ub_on_tufts/hdf5/larformer_cache_stage12__ptv3crosslevelslicer_iter_75750
SAVE=${WORKDIR}/exp/_smoke_particle_m2frecipe
mkdir -p "${SAVE}"

#!/bin/bash
# LArFormer Stage-2 slicer M2F-RECIPE V2 retrain -- 4x A100-80GB, 5-epoch OneCycle.
#
...
#
#   sbatch submit_larformer_slicer_m2frecipe_v2_a100.sh

#SBATCH --job-name=lf-slicer-m2fv2
#SBATCH --mem=192G
...
#SBATCH --output=logs/lf-slicer-m2fv2.%j.%N.log
#SBATCH --error=logs/lf-slicer-m2fv2.%j.%N.err
...
SELF=${SCRIPT_DIR}/submit_larformer_slicer_m2frecipe_v2_a100.sh

SAVE=${WORKDIR}/exp/larformer_slicer_v1_cascaded_ptv3hybrid_crosslevel_cap300k_m2frecipe_v2

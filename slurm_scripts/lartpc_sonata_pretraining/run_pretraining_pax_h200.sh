...
#python3 tools/train.py --config configs/lartpc/pretrain-sonata-v1m1-lartpc-v5.py --num-gpus 2
# 
...
#python3 tools/train.py --config configs/lartpc/pretrain-sonata-v1m1-lartpc-v5.py --num-gpus 2 --options resume=True weight=${CHECKPOINT_FILE}

# ---------------------------------------------------------------------
# TRAIN v6
# Attempt: 390k training set, batchsize 64, larger model
#python3 tools/train.py --config configs/lartpc/pretrain-sonata-v1m1-lartpc-v6.py --num-gpus 2
#
...
# python3 tools/train.py --config configs/lartpc/pretrain-sonata-v1m1-lartpc-v6.py --num-gpus 2 --options resume=True weight=${CHECKPOINT_FILE}
